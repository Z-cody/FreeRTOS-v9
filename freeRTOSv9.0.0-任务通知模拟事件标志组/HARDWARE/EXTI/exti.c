...
//extern TaskHandle_t TASK3_Handler;	//接收任务的句柄
//S1
...
//	
//	if(TASK3_Handler != NULL)			//任务存在
//	{
//		vTaskNotifyGiveFromISR(TASK3_Handler,&xHigherPriorityTaskWoken);	//发送任务通知,任务的ulNotifiedValue+1
